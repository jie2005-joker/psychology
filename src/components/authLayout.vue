<template>
  ...
  <div class="auth-layout">
    <div class="left-section">
      <div class="content">
        <h1 class="title">心理健康AI助手</h1>
        <p class="text">每个深夜,每个焦虑的时刻,我们都在这里.不必独自承受,让心与心的连接温暖您的每一天.</p>
        <div class="robot">
          <el-image :src="authImg" style="width: 90px; height: 90px;"></el-image>
        </div>
      </div>
    </div>
...
<script setup>
const authImg = new URL('@/assets/images/robot-fill.png', import.meta.url).href
</script>
