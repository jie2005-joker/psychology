  ...
  <div class="articleDetail-container">
    ...
    <div class="content">
      <div class="diary-card">
        ...
        <div class="flex-box" style="margin-top: 20px; gap: 20px;">
          <div class="flex-box">
          ...
          <div class="flex-box">
            ...
            <span>阅读量：{{articleDetail.readCount}}</span>
          </div>
        </div>
      </div>
      <div class="diary-card">
        ...
        <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length > 0">
          ...
          <div class="tags-list">
            <el-tag v-for="tag in articleDetail.tagArray" :key="tag" class="tag-item">{{tag}}</el-tag>
          </div>
        </div>
      </div>
